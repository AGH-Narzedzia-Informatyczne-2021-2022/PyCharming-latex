...
\par By the way, the only reason you see this formula here is to \underline{follow the requirment} and to just \underline{to get the box ticked}.
\begin{align*}
S(\omega) 
